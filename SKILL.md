...
| [external-resources.md](external-resources.md) | Agent-facing links by Mode (~25); art catalog in `tools/digital-assets.md`; maintainer index in `references/web-resources.md` |
