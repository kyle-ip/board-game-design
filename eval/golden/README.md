...
| File | Purpose |
|---|---|
| `design-state-schema.md` | Required sections and v3 optional fields |
...
1. Run agent on benchmark prompt (Cases A–F in `eval/benchmark-prompts.md`)
...
4. Behavior criteria (routing, diagnosis) still require manual scoring per `eval/README.md`
...
Fixtures should pass structural checks. Behavior benchmarks (Cases A–F) remain manual.
